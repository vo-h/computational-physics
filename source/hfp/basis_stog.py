...
class STOGIntegrator:
    ...
    def Vij(self, orb1: STOGOrbital, orb2: STOGOrbital) -> float:
        """Calculate the electron-nuclear attraction integral between two STO-nG orbitals."""
        pass
    ...
    def compute_vi(self, gto1: STOGPrimitive, gto2: STOGPrimitive, component: Literal['x', 'y', 'z'] = 'x') -> float:
    ...
    def compute_integral_by_func(self, gto1: STOGPrimitive, gto2: STOGPrimitive, func: Callable, component: Literal['x', 'y', 'z'] = 'x') -> float:
        ...
        return func(A, B, P, gto1.alpha, gto2.alpha, ai, bi)
